                    ...
                    columns: [
                        ...
                        {//create column group
                            ...
                            columns: [
                                ...
                                {title: "H", field: "hdata", headerFilter: "input", width: "60", editor: "input"},
                                {title: "FA", field: "fa", headerFilter: "input", width: "60", editor: "input"},
                                {title: "OR", field: "or", headerFilter: "input", width: "60", editor: "input"},
                                {title: "BNA/Conn Angle", field: "bna", headerFilter: "input", width: "100", editor: "input"},
                                {title: "BNK-Ht", field: "bnk", headerFilter: "input", width: "100", editor: "input"},
                            ],
                        },
                        {//create column group
                            ...
                            columns: [
                                ...
                                {title: "Smallest Ball Size", field: "smallest", headerFilter: "input", width: "120", editor: "input"},
                                {title: "Bonder Platform", field: "bonder", headerFilter: "input", width: "120", editor: "input"},
                                {title: "Package/Application/Device", field: "package", align: "center", headerFilter: "input", width: "180", editor: "input"},
                                {title: "STD L/F (MAX)", field: "stdmax", align: "center", sorter: "number", headerFilter: "input", width: "150", editor: "input"},
                                {title: "STD L/F (ACTUAL)", field: "stdactual", align: "center", headerFilter: "input", width: "150", editor: "input"},
                                {title: "ROUGHENED  L/F (MAX)", field: "roughmax", align: "center", headerFilter: "input", width: "170", editor: "input"},
                                {title: "ROUGHENED  L/F (ACTUAL)", field: "roughactual", align: "center", sorter: "number", headerFilter: "input", width: "170", editor: "input"},
                                {title: "$/MTD PPF", field: "mtdppf", align: "center", headerFilter: "input", width: "120", editor: "input"},
                                {title: "$/MTD RLF", field: "mtdrlf", align: "center", headerFilter: "input", width: "150", editor: "input"},
                                {title: "Clean/Rejuv?", field: "clean", align: "center", headerFilter: "input", width: "150", editor: "input"},
                                {title: "Rework/Refresh", field: "rework", align: "center", sorter: "string", headerFilter: "input", width: "150", editor: "input"},
                                {title: "Dual Source?", field: "dual", align: "center", sorter: "string", headerFilter: "input", width: "120", editor: "input"},
                                {title: "Remarks", field: "remarks", align: "center", sorter: "string", headerFilter: "input", width: "180", editor: "input"},
                            ],
                        },
                    ],
