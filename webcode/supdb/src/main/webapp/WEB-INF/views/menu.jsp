...
<nav class="navbar navbar-inverse" role="navigation">
    <div class="container-fluid">
        ...
        <div class="navbar-header">
            ...
            <a class="navbar-brand" href='#'>Assembly Supplier CCA</a>
        ...
        <ul class="nav navbar-nav navbar-left collapse navbar-collapse" id="main-navbar-collapse">
            ...
            <li class="dropdown">
              ...
              <li class="dropdown">
                <a href="#" class="dropdown-toggle" data-hover="dropdown">Employee <b class="caret"></b></a>
                <ul class="dropdown-menu">
                    <li><a href='<c:url value="/listemployees?fullname=DP1DM5"/>'>Employee list</a></li>                    
                </ul>
            </li>
