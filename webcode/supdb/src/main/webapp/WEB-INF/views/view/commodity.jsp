    ...
    <body>
        ...
        <div>
            <div height="150px"> <div class="btn-group" role="group" aria-label="Basic example">
                    <button type="button" id="download-xlsx" class="btn btn-secondary">Download</button>
                    ...
                    columns: [
                        {//create column group
                            ...
                            columns: [
                                ...
                                {title: "U Price", field: "price", align: "center", sorter: "number", editor: "input", headerFilter: "input", width: "100"},
